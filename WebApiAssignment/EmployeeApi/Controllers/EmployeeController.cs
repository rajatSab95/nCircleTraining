...
namespace Controllers
{
    ...
    public class EmployeeController
    {
        ...
        [HttpGet("code/{codart}")]
        public IEnumerable<Employee> ListEmployeesById(string id)
        {
            int Id ;
            int.TryParse(id, out Id);
             IEnumerable<Employee> result =
                from e in Database.Employees 
                where e.Id==Id
                select e;
        ...
        [HttpGet("emp/male")]
        public IEnumerable<Employee> ListMaleEmployees()
        {
            IEnumerable<Employee> result =
                from e in Database.Employees 
                where e.Gender.ToLower()=="gender.male"
                select e;
         ...
         [HttpGet("emp/female")]
        public IEnumerable<Employee> ListFemaleEmployees()
        {
            IEnumerable<Employee> result =
                from e in Database.Employees 
                where e.Gender.ToLower()=="gender.female"
                select e;
...
public class Database{
    public static List<Employee> Employees = new List<Employee>(){ new Employee(){Id=1 ,FirstName="Arvind", LastName="Kejriwal", Department=1, Gender="Male", Country="Country.UK", Salary=12351, Dob=new DateTime(1999,05,01)},
